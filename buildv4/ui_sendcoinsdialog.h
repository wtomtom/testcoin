...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 TES"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 TES"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 TES"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 TES"));
        ...
        labelBalance->setText(QStringLiteral("123.456 TES"));
